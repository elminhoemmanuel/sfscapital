            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12'>
                <Link href='/plans/maize'>
                    <a className='block rounded-lg bg-white text-black shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className='px-4 py-8'>
                            <h1 className='text-xl mb-5 font-bold'>Maize Farming</h1>
                ...
                <Link href='/plans/maize'>
                    <a className='block rounded-lg bg-white text-black shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className='px-4 py-8'>
                            <h1 className='text-xl mb-5 font-bold'>Cabbage Farming</h1>
                            <div className='flex items-center justify-between mb-7'>
                                <div className='flex items-center'>
                                    <div className='mr-2'>
                                        <FaStopwatch className='text-greensec w-6 h-6' />
                ...
                <Link href='/plans/maize'>
                    <a className='block rounded-lg bg-white text-black shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className='px-4 py-8'>
                            <h1 className='text-xl mb-5 font-bold'>Mechanization Package</h1>
                            <div className='flex items-center justify-between mb-7'>
                                <div className='flex items-center'>
                                    <div className='mr-2'>
                                        <FaStopwatch className='text-greensec w-6 h-6' />
                ...
                <Link href='/plans/maize'>
                    <a className='block rounded-lg bg-white text-black shadow-xl transition duration-300 ease-in-out transform hover:-translate-y-1 hover:scale-110'>
                        ...
                        <div className='px-4 py-8'>
                            <h1 className='text-xl mb-5 font-bold'>Cassava Farming</h1>
                            <div className='flex items-center justify-between mb-7'>
                                <div className='flex items-center'>
                                    <div className='mr-2'>
                                        <FaStopwatch className='text-greensec w-6 h-6' />
