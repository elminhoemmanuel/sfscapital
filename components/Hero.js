        ...
        <div className="pb-8 grid grid-cols-1 md:grid-cols-2">
            <div className="pt-24 pl-6 md:pl-12 pr-6 md:pr-0">
                <div className="flex flex-col justify-center pt-12 pb-16">
                    <h1 className='text-sfsblue font-bold text-3xl md:text-4xl mb-2'>Our Mission is to</h1>
                    <h1 className='text-sfsblue font-bold text-3xl md:text-4xl mb-2'>Empower your </h1>
                    <h1 className='text-sfsblue font-bold text-3xl md:text-4xl mb-2'>Financial  Freedom</h1>
