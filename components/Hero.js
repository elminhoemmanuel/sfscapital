    ...
    return (
        <div className={styling}>
            <div className="mb-8 text-left w-full md:w-4/5 lg:w-1/2 mx-auto">
                <h1 className='text-white font-bold tracking-wider text-4xl'>The best free stock photos</h1>
                <h1 className='text-white font-bold tracking-wider text-4xl'>shared by talented creators.</h1>
            </div>
            <SearchField />
        </div>
    )
